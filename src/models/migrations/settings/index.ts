...
import { migrateV15ToV16 } from './0016';
import { migrateV16ToV17, SettingsV17 } from './0017';
...
export function migrate(data: unknown): SettingsV17 {
  ...
  return SettingsV17.parse(curData);
}
